...
QT_MOC_LITERAL(3, 22, 8), // "logLevel"
QT_MOC_LITERAL(4, 31, 7) // "message"

    },
    "CamThread\0logMessage\0\0logLevel\0message"
};
...
void CamThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CamThread::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CamThread::logMessage)) {
                *result = 0;
                return;
            }
        }
