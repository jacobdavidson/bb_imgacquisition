 ...
 */
    ...
    typedef enum CUctx_flags_enum
    {
        ...
        CU_CTX_BLOCKING_SYNC =
            0x04, /**< Set blocking synchronization as default scheduling \deprecated */
    ...
    typedef enum CUdevice_attribute_enum
    {
        ...
        CU_DEVICE_ATTRIBUTE_TOTAL_CONSTANT_MEMORY =
            9,                              /**< Memory available on device for __constant__
    ...
    typedef enum CUcomputemode_enum
    {
        ...
        CU_COMPUTEMODE_EXCLUSIVE =
            1, /**< Compute-exclusive-thread mode (Only one context used by a
                  single thread can be present on this device at a time) */
        CU_COMPUTEMODE_PROHIBITED = 2 /**< Compute-prohibited mode (No contexts can be created on
                                         this device at this time) */
#if __CUDA_API_VERSION >= 4000
        ,
        CU_COMPUTEMODE_EXCLUSIVE_PROCESS =
            3 /**< Compute-exclusive-process mode (Only one context used by a single process can be
...
typedef CUresult CUDAAPI tcuDeviceTotalMem(unsigned int* bytes, CUdevice dev);
    ...
    typedef CUresult CUDAAPI tcuModuleGetFunction(CUfunction* hfunc,
                                                  CUmodule    hmod,
                                                  const char* name);
...
typedef CUresult CUDAAPI tcuModuleGetGlobal(CUdeviceptr* dptr,
    ...
    typedef CUresult CUDAAPI tcuModuleGetTexRef(CUtexref*   pTexRef,
                                                CUmodule    hmod,
                                                const char* name);
    typedef CUresult CUDAAPI tcuModuleGetSurfRef(CUsurfref*  pSurfRef,
                                                 CUmodule    hmod,
                                                 const char* name);
 ...
 ***********************************/
    ...
    typedef CUresult CUDAAPI tcuMemAllocPitch(CUdeviceptr* dptr,
                                              ...
                                              size_t       WidthInBytes,
                                              size_t       Height,
                                              // size of biggest r/w to be performed by kernels on
                                              // this memory 4, 8 or 16 bytes
...
typedef CUresult CUDAAPI tcuMemAllocHost(void** pp, unsigned int bytesize);
    ...
    typedef CUresult CUDAAPI tcuMemHostGetDevicePointer(CUdeviceptr* pdptr,
                                                        void*        p,
                                                        unsigned int Flags);
...
// 1D functions
    ...
    typedef CUresult CUDAAPI tcuMemcpyHtoA(CUarray     dstArray,
                                           ...
                                           const void* srcHost,
                                           size_t      ByteCount);
    typedef CUresult CUDAAPI tcuMemcpyAtoH(void*   dstHost,
                                           CUarray srcArray,
                                           size_t  srcOffset,
                                           size_t  ByteCount);
...
typedef CUresult CUDAAPI tcuMemcpyDtoH(void* dstHost,
                                       CUdeviceptr srcDevice,
                                       unsigned int ByteCount);
...
// 1D functions
    ...
    typedef CUresult CUDAAPI tcuMemcpyHtoAAsync(CUarray     dstArray,
                                                ...
                                                size_t      ByteCount,
                                                CUstream    hStream);
    typedef CUresult CUDAAPI tcuMemcpyAtoHAsync(void*    dstHost,
                                                CUarray  srcArray,
                                                size_t   srcOffset,
                                                size_t   ByteCount,
                                                CUstream hStream);
...
typedef CUresult CUDAAPI tcuMemsetD2D32(CUdeviceptr dstDevice,
    ...
    typedef CUresult CUDAAPI tcuArrayCreate(CUarray*                     pHandle,
                                            const CUDA_ARRAY_DESCRIPTOR* pAllocateArray);
    typedef CUresult CUDAAPI tcuArrayGetDescriptor(CUDA_ARRAY_DESCRIPTOR* pArrayDescriptor,
                                                   CUarray                hArray);
    typedef CUresult CUDAAPI tcuArrayDestroy(CUarray hArray);

    typedef CUresult CUDAAPI tcuArray3DCreate(CUarray*                       pHandle,
                                              const CUDA_ARRAY3D_DESCRIPTOR* pAllocateArray);
    typedef CUresult CUDAAPI tcuArray3DGetDescriptor(CUDA_ARRAY3D_DESCRIPTOR* pArrayDescriptor,
                                                     CUarray                  hArray);
    ...
    typedef CUresult CUDAAPI tcuTexRefSetArray(CUtexref     hTexRef,
                                               CUarray      hArray,
                                               unsigned int Flags);
...
typedef CUresult CUDAAPI tcuGraphicsResourceGetMappedPointer(CUdeviceptr* pDevPtr,
    ...
    typedef CUresult CUDAAPI tcuGraphicsResourceSetMapFlags(CUgraphicsResource resource,
                                                            unsigned int       flags);
